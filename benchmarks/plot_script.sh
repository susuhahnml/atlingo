...
python plot.py --approach afw --approach asp --approach afw_del --prefix="rules-bodies"  --horizon 7  --stat rules --models 0 --approach nc  --stat bodies  --ignore_prefix structured/x10 --mean --tikz
...
# Analize conflicts and choices
python plot.py --approach grid-afw  --approach grid-afw_del --approach grid-asp --approach grid-nc --prefix="grid-conflicts-5"  --horizon 5 --models 0 --table --stat conflicts --mean --ignore_prefix structured/x10
