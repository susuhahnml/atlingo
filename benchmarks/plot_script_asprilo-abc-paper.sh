...
BASE='--models 0 --x #horizon --env asprilo-abc '
R2='--instance _r2_'
R3='--instance _r3_'
...
############ Processing Time
# python plot.py  ${BASE} ${ALL_APP} ${R2} --horizon 24 --type table --stat ptime --prefix="ptime-" --y 'Processing time (sec)'
# python plot.py  ${BASE} ${ALL_APP} ${R3} --horizon 24 --type table --stat ptime --prefix="ptime-" --y 'Processing time (sec)'

# ############ Clingo Times
# python plot.py  ${BASE} ${ALL_APP} ${R2} ${HORIZON_R2} --type table --stat ctime --prefix="time-" --y 'Clingo time (sec)'
# python plot.py  ${BASE} ${ALL_APP} ${R3} ${HORIZON_R3} --type table --stat ctime --prefix="time-" --y 'Clingo time (sec)'

# ############ Choices
# python plot.py  ${BASE} ${ALL_APP} ${R2} ${HORIZON_R2} --type table --stat choices --prefix="choices-" --y '#choices'
# python plot.py  ${BASE} ${ALL_APP} ${R3} ${HORIZON_R3} --type table --stat choices --prefix="choices-" --y '#choices'

# ############ Constraints
# python plot.py  ${BASE} ${ALL_APP} ${R2} ${HORIZON_R2} --type table --stat cons --prefix="cons-" --y '#cons'
# python plot.py  ${BASE} ${ALL_APP} ${R3} ${HORIZON_R3} --type table --stat cons --prefix="cons-" --y '#cons'

# ############ Rules
# python plot.py  ${BASE} ${ALL_APP} ${R2} ${HORIZON_R2} --type table --stat rules --prefix="rules-" --y '#rules'
